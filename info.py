...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS','1960614875,1163754519').split()]
...
S_GROUP = environ.get('S_GROUP',"https://t.me/moviesadda0098")
MAIN_CHANNEL = environ.get('MAIN_CHANNEL',"https://t.me/Movies_adda24_7")
